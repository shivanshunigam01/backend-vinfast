...
exports.crmCreateLeadValidator = [
  ...
  body('leadType').optional().trim(),
  body('salesConsultant').optional({ values: 'falsy' }).trim(),
  body('enquiryDate').optional({ values: 'falsy' }).trim(),
  body('callDate').optional({ values: 'falsy' }).trim(),
  body('existingVariant').optional({ values: 'falsy' }).trim(),
